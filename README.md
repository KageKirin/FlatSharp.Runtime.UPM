# FlatSharp.Runtime.UPM (DLL)

This repo contains a couple of build scripts to wrap
the .net standard 2.1 DLL for the
[FlatSharp.Runtime](https://github.com/jamescourtney/FlatSharp/) FlatBuffers library
into a Unity package addressable through Unity Package Manager.

**THIS PACKAGE ONLY CONTAINS `FlatSharp.Runtime.dll`.**

The source code for FlatSharp.Runtime is not contained here.
